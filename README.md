...
An AI agent later [replayed the r2 source](https://github.com/Zhi-Chao-PAN/research-agent-bench/blob/2f60443dc5cd00949d031542f83c2950b956a1e8/POST_RELEASE_R2_SOURCE_REPLAY_2026-09-23.md) from a retained, hash-matched NFCorpus archive in a new environment on the same machine. This supports bounded numerical reproducibility, not a blind test, cross-machine replication, or my unaided practice.

[One-page proof](https://www.panzhichao.com/evidence/autoresearch-v12-project-proof-pan-zhichao.pdf) · [Research Agent fixed-source reviewer ZIP](https://github.com/Zhi-Chao-PAN/research-agent-bench/releases/download/reviewer-snapshot-2026-09-23-r2/research-agent-bench-reviewer-snapshot-2026-09-23-r2-reviewer-bundle.zip) · [LoRA fixed-source reviewer ZIP](https://github.com/Zhi-Chao-PAN/lora-robustness-reproduction/releases/download/reviewer-snapshot-2026-09-23/lora-robustness-reproduction-reviewer-snapshot-2026-09-23-reviewer-bundle.zip). Each ZIP includes tagged source, a file-hash manifest, a short review guide and offline checks; raw datasets and pretrained weights remain with their upstream providers. Release notes pin the ZIP hashes and the scope of the checks.
