...
- **[Battery Prognostics](https://github.com/Zhi-Chao-PAN/safety-critical-battery-prognostics)**：物理约束电池预测与鲁棒性评估，区分合成实验和真实电芯结果的适用范围。[项目案例](https://www.panzhichao.com/zh/projects/safety-critical-battery-prognostics)。
